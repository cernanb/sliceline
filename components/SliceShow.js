...
const SliceShow = ({ id }) => {
  if (!id) return null
  const { loading, error, data } = useQuery(SINGLE_SLICE_QUERY, {
    variables: { id }
  })
  ...
  return (
    <>
      <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-6 lg:my-0">
        <div
          id="profile"
        ...
        >
          <div class="p-4 md:p-12 text-center lg:text-left">
            ...
            <h1 class="text-3xl font-bold pt-8 lg:pt-0">{slice.name}</h1>
            <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-teal-500 opacity-25"></div>

            <p class="pt-8 text-sm">{slice.description}</p>
      ...
      <form>
        <div>
          <div>
            <div>
              <h3 class="text-lg leading-6 font-medium text-gray-900">Reviews</h3>
            </div>
            <div class="mt-6 grid row-gap-6 col-gap-4 ">
              <div>
              ...
              <div class="">
                ...
                <p class="mt-2 text-sm text-gray-500">Write a few sentences about this slice.</p>
              </div>
            </div>
          </div>
        </div>
...
export default withApollo({ ssr: true })(SliceShow)
